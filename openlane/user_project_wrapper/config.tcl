...
set ::env(CLOCK_NET) "top_wrapper.clk"
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$::env(CARAVEL_ROOT)/verilog/rtl/defines.v \
	$::env(DESIGN_DIR)/../../verilog/rtl/top_wrapper.v"

set ::env(EXTRA_LEFS) "\
	$::env(DESIGN_DIR)/../../lef/top_wrapper.lef"

set ::env(EXTRA_GDS_FILES) "\
	$::env(DESIGN_DIR)/../../gds/top_wrapper.gds"
